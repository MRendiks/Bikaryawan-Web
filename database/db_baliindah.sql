...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Jan 2023 pada 06.26
...
--
-- Struktur dari tabel `db_deksripsi`
--

CREATE TABLE `db_deksripsi` (
...
--
-- Struktur dari tabel `tb_enrkripsi`
--

CREATE TABLE `tb_enrkripsi` (
...
--
-- Indeks untuk tabel `db_deksripsi`
--
ALTER TABLE `db_deksripsi`
...
--
-- Indeks untuk tabel `tb_enrkripsi`
--
ALTER TABLE `tb_enrkripsi`
...
--
-- AUTO_INCREMENT untuk tabel `db_deksripsi`
--
ALTER TABLE `db_deksripsi`
  MODIFY `id_dekripsi` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `tb_enrkripsi`
--
ALTER TABLE `tb_enrkripsi`
  MODIFY `id_enkripsi` int(11) NOT NULL AUTO_INCREMENT;
